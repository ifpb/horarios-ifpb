...
<div class="flex items-center">
    <div class="md:w-1/2 md:mx-auto">
        <div class="rounded shadow">
            <div class="font-medium text-lg text-white bg-green p-3 rounded-t">
            ...
            <div class="bg-white p-3 rounded-b">
                <form class="form-horizontal" method="POST" action="{{ route('password.request') }}">
                    ...
                    <div class="flex items-stretch mb-3">
                        <label for="password" class="text-right font-semibold text-grey-darker text-sm pt-2 pr-3 align-middle w-1/4">{{ __('Nova senha') }}</label>
                        <div class="flex flex-col w-3/4">
                    ...
                    <div class="flex items-stretch mb-3">
                        <label for="password_confirmation" class="text-right font-semibold text-grey-darker text-sm pt-2 pr-3 align-middle w-1/4">{{ __('Confirme a nova senha') }}</label>
                        <div class="flex flex-col w-3/4">
                    ...
                    <div class="flex">
                        <div class="w-3/4 ml-auto">
                            <button type="submit" class="bg-green hover:bg-green-darker text-white text-sm font-semibold py-2 px-4 rounded mr-3">
                                {{ __('Redefinir senha') }}
                            </button>
                        </div>
                    </div>
