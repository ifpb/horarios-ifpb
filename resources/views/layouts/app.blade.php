...
<head>
    ...
    <meta name="description" content="Confira já os horários do IFPB na paraíba. Sistema de horários atualizado com blocos e salas e aula.">
...
<body class="flex min-h-screen flex-col">
    <header>
        <div class="top-bar bg-grey-light">
            <div class="container flex justify-between text-sm items-center">
                ...
                <div class="links flex justify-center w-full md:w-auto">
                    <a href="https://suap.ifpb.edu.br/" rel="noreferrer" target="_blank" title="SUAP">Acesso ao SUAP</a>
                    <a href="https://www.ifpb.edu.br/" rel="noreferrer" target="_blank" title="Site do IFPB">Site do IFPB</a>
                </div>
            </div>
        </div>
        <div class="header-main text-white pt-10">
            <div class="container md:flex md:justify-between md:items-center px-5 md:px-0">
                ...
                <div class="mt-8 md:w-1/2 md:mt-0" id="prefetch">
                    <input class="search-input typeahead w-full" aria-label="Que curso deseja encontrar?" type="text" placeholder="Que curso deseja encontrar?">
                </div>
            </div>

            <div class="container mt-10 flex flex-col md:flex-row">
                <a href="{{ route('main.courses') }}" title="Cursos" class="button-main-menu">
                    <i>
                ...
                <a href="{{ route('main.labs') }}" title="Laboratórios" class="button-main-menu">
                    <i>
                ...
                <a href="{{ route('main.classrooms') }}" title="Salas de Aula" class="button-main-menu">
                    <i>
                ...
                <a href="{{ route('main.professors') }}" title="Professores" class="button-main-menu">
                    <i>
    ...
    {{-- TODO: Usar o Laravel Breadcumbs para gerar isto --}}
    ...
    <div class="bg-green-darker text-white py-5 px-5">
        <div class="container">
            <a href="http://www.acessoainformacao.gov.br/" rel="noreferrer" class="flex items-center font-normal text-sm no-underline text-white hover:text-white w-48" title="Acesso à Informação - Governo Federal" target="_blank">
                        ...
                        <g id="Horário-Mobile" transform="translate(-29.000000, -556.000000)">
                            <g id="Acesso-a-informação" transform="translate(0.000000, 535.000000)">
                                <g id="Acesso" transform="translate(29.000000, 21.000000)">
                                    <circle class="Oval" fill="#F6A800" cx="22.5" cy="22.5" r="22.5"></circle>
                                    <path d="M4.36187726,34 L2.25273475,40.0047825 C1.43417236,42.3290217 2.67097831,43.5658276 4.9952175,42.7472652 L11,40.6381227 L4.36187726,34 Z" class="Shape" fill="#F6A800"></path>
                                    <circle class="Oval" fill="#00692C" cx="22.5" cy="11.5" r="4.5"></circle>
                                    <path d="M22.5,18 C20.016,18 18,20.0894285 18,22.6639029 L18,34.3360971 C18,36.9105715 20.016,39 22.5,39 C24.984,39 27,36.9105715 27,34.3360971 L27,22.6639029 C27,20.0894285 24.984,18 22.5,18 Z" class="Shape" fill="#00692C"></path>
                                </g>
                            </g>
                        </g>
                    </g>
    ...
    <script src="{{ asset('js/vendor/jquery.autocomplete.js') }}"></script>

    <script>
        $('.typeahead').autocomplete({
            serviceUrl: '/api/info/cursos',
